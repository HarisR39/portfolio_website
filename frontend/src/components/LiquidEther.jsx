...
// Full fluid-like background effect using THREE, as provided
...
`
    ...
    // Kick off auto driver immediately so background animates without waiting for inactivity
    if (webgl.autoDriver) {
      webgl.lastUserInteraction = performance.now() - (webgl.autoDriver.resumeDelay + 100)
    }
